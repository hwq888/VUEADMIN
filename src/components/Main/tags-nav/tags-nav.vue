    ...
    <div class="close-con">
      <el-dropdown trigger="hover">
        ...
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item v-for="(item, key) of menuList" @click.native="handleTagsOption(key)" :key="key">{{item}}</el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
    </div>
    <div class="btn-con left-btn">
      <a class="btn" @click="handleScroll(240)">
        <i class="iconfont">&#xe773;</i>
      </a>
    </div>
...
export default {
  ...
  methods: {
    ...
    isCurrentTag (item) {
      // debugger
      // console.log('isCurrentTag start')
      // console.log(item)
      // console.log(this.currentRouteObj)
      // console.log(item)
      // console.log('isCurrentTag end')
